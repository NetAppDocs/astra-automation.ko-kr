...
summary: 다음 스크립트를 사용하여 Astra 계정의 응용 프로그램을 나열할 수 있습니다. 
---
= 앱을 나열합니다
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
다음 스크립트를 사용하여 Astra 계정의 응용 프로그램을 나열할 수 있습니다.


NOTE: 을 참조하십시오 link:../python/python_before.html["시작하기 전에"] 필요한 JSON 입력 파일의 예
